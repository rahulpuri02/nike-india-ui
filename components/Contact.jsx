        ...
        <div className="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
          <form>
            <div className="form-group mb-6">
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:border-zinc-200 focus:border-zinc-200 focus:outline-none" id="exampleInput7"
                placeholder="Name" />
            </div>
            <div className="form-group mb-6">
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:border-zinc-200 focus:border-zinc-200 focus:outline-none" id="exampleInput8"
            ...
            <div className="form-group mb-6">
              ...
              ease-in-out
              m-0
              focus:text-gray-700 focus:border-zinc-200 focus:border-zinc-200 focus:outline-none
            ...
            <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
              <div className="flex items-start">
                <div className="shrink-0">
                  <div className="p-4 bg-[#111] rounded-md shadow-md w-14 h-14 flex items-center justify-center">
